...
\title{F1 2011 Abu Dhabi (Race)\thanks{Source data used to generate this report was obtained from the Timing Information press releases published via the F1/FIA Media Centre }\\A Statistical Graphics Review}
...
tomp=subset(racestats,finish>0)
